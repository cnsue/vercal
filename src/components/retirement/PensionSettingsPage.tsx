      ...
      {show && (
        <div style={{ marginTop: 12, fontSize: 12, lineHeight: 1.7, color: 'var(--text)' }}>
          ...
          <ExampleSection title="③ 缴费指数">
            <ExampleRow label="已缴费期间平均指数" value="1.00" hint="本人工资 ÷ 当地社平。1.00 即跟社平差不多（一般工薪族）；查 APP 里「缴费工资指数」最准，工资在社平 1.5 倍就填 1.50" />
          ...
          <ExampleSection title="⑤ 个人账户">
            <ExampleRow label="累计余额" value="100,000" hint="在社保 APP 首页「账户查询」能看到。13 年 × 1.0 社平 × 8% × 12 月 ≈ 10 万；不知道就先填 0，影响约 300-800 元/月的精度" />
          </ExampleSection>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 12, color: 'var(--text)', lineHeight: 1.7 }}>
              月养老金约 <strong style={{ color: 'var(--primary)' }}>¥8,400 / 月</strong>（按 1% 社平增长 + 1.62% 记账利率口径）<br />
              ＝ 基础养老金 ~¥4,400 ＋ 个人账户养老金 ~¥4,000<br />
              <span style={{ color: 'var(--muted)' }}>对比全默认（0% / 2.62%）大约高 ¥600/月——1% 社平增长把退休时社平拉高的效应，盖过了 1.62% 利率减少的复利。实际数额随社平、记账利率、退休年份政策变化，以人社局测算为准。</span>
            </div>
          </div>
          ...
          <ExampleSection title="📈 弹性退休的 ±3 年差多少？外加一个最有用的杠杆">
            ...
            <ExampleRow
              ...
              value="¥10,700 / 月 (+54%)"
              hint="缴费基数翻倍到 2.0 倍社平。只影响未来缴费段，过去 8 年算 1.0 不变" />
            <div style={{
              marginTop: 6, padding: 10, background: 'var(--surface)', borderRadius: 8,
              border: '1px dashed var(--primary-border)',
              fontSize: 11, lineHeight: 1.7, color: 'var(--text)',
            }}>
              💡 <strong>弹性退休上限就是 ±3 年</strong>。早退 1 年代价约 -6%，晚退 1 年收益约 +9%（不对称是因为复利方向不同）；超过 ±3 年的档位在 UI 里选不到，再想往上挪只能靠把未来缴费基数撑上去。两个能动的杠杆叠加（晚退 3 年 + 指数 2.0）能算到 <strong>¥13,900 / 月</strong>（+100%），但代价是真要多干 3 年 + 工资得真涨上去。
            </div>
          </ExampleSection>
