        ...
        <div style={{ marginTop: 12, fontSize: 12, lineHeight: 1.7, color: 'var(--text)' }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 12, color: 'var(--text)', lineHeight: 1.7 }}>
              月养老金约 <strong style={{ color: 'var(--primary)' }}>¥9,000+</strong>（按 1% 社平增长 + 1.62% 记账利率口径）<br />
              ＝ 基础养老金 ~¥4,400 ＋ 个人账户养老金 ~¥4,700<br />
              <span style={{ color: 'var(--muted)' }}>对比全默认（0% / 2.62%）大约低 ¥600/月——主要是 0% 增长把退休时社平压住。实际数额随社平、记账利率、退休年份政策变化，以人社局测算为准。</span>
            </div>
          </div>
