      ...
      {show && (
        <div style={{ marginTop: 12, fontSize: 12, lineHeight: 1.7, color: 'var(--text)' }}>
          ...
          <ExampleSection title="③ 缴费指数">
            <ExampleRow label="已缴费期间平均指数" value="0.60" hint="本人缴费基数 ÷ 当地社平。0.60 是最低档（很多中小企业 / 灵活就业实际就是按最低基数缴费）；按实际工资缴的填 1.00 左右；查 APP 里「缴费工资指数」最准" />
            <ExampleRow label="未来期望平均指数" value="0.60" hint="假设单位继续按最低基数缴；预期升迁 / 跳槽到按真实工资缴费的公司选 1.00-1.50" />
          </ExampleSection>
          ...
          <ExampleSection title="④ 可选参数（建议改一改，不要全用默认）">
            ...
            <div style={{
              ...
              <strong>社平增长 1%</strong>：人社部测算器默认 0%，对应"假设社平永远不涨"，但过去 10 年杭州 / 上海实际社平名义增速都在 5–7%、扣通胀后约 1–2%。0% 会**系统性低估**基础养老金（公式里"退休上年度社平"会按这个增长率外推到 27 年后）。给 1% 是按今日购买力 + 实质增长 1% 的口径，更贴近近 5 年实际数据；想看名义金额可继续上调到 3–5%。<br /><br />
          ...
          <div style={{
            ...
            <div style={{ fontSize: 12, color: 'var(--text)', lineHeight: 1.7 }}>
              月养老金约 <strong style={{ color: 'var(--primary)' }}>¥6,000 / 月</strong>（按 1% 社平增长 + 1.62% 记账利率口径）<br />
              ＝ 基础养老金 ~¥3,500 ＋ 个人账户养老金 ~¥2,500<br />
              <span style={{ color: 'var(--muted)' }}>对比全默认（0% / 2.62%）大约高 ¥500/月——1% 社平增长把退休时社平拉高的效应，盖过了 1.62% 利率减少的复利。实际数额随社平、记账利率、退休年份政策变化，以人社局测算为准。</span>
            </div>
          </div>
          ...
          <ExampleSection title="👥 男 vs 女工人：退休早 8 年，养老金差多少？">
            <ExampleRow
            ...
            <ExampleRow
              ...
              value="¥3,800 / 月 (−37%)"
              hint="同样 1990-05 生 + 13 年 + 0.6 指数 + 7 万余额。比男性早退 8 年：基础养老金少 8 年缴费 + 个人账户少 8 年累计 + 计发月数 117→170，三重叠加" />
            <div style={{
              marginTop: 6, padding: 10, background: 'var(--surface)', borderRadius: 8,
              border: '1px dashed var(--primary-border)',
              fontSize: 11, lineHeight: 1.7, color: 'var(--text)',
            }}>
              💡 女工人退休年龄低**不是"福利"**——养老金体系按缴费年限 + 个人账户余额算，早退 = 少领。
              如果工资水平可观，<strong>弹性退休 +3 年（55→58 岁）</strong>能把月养老金拉回 <strong>~¥4,500</strong>（比标准多 ¥700/月），相当于用 3 年的工作换 30 年的多领。
            </div>
          </ExampleSection>
