...
const BASE_DIVIDEND_STOCKS: Omit<DividendAssetRef, 'assetType'>[] = [
  ...
  { code: '601398', name: '工商银行',   dividendPerShare: 0.3103, asOfYear: '2025', referencePrice: 7.47,  priceAsOf: '2026-05-11', category: '银行',
    growth: { pessimistic: 0.00, neutral: 0.03, optimistic: 0.05 } },
  { code: '601939', name: '建设银行',   dividendPerShare: 0.3887, asOfYear: '2025', referencePrice: 9.60,  priceAsOf: '2026-05-11', category: '银行',
    growth: { pessimistic: 0.01, neutral: 0.04, optimistic: 0.06 } },
  { code: '601288', name: '农业银行',   dividendPerShare: 0.2495, asOfYear: '2025', referencePrice: 6.81,  priceAsOf: '2026-05-11', category: '银行',
    growth: { pessimistic: 0.02, neutral: 0.05, optimistic: 0.08 } },
  { code: '601988', name: '中国银行',   dividendPerShare: 0.2263, asOfYear: '2025', referencePrice: 5.68,  priceAsOf: '2026-05-11', category: '银行',
    growth: { pessimistic: 0.01, neutral: 0.04, optimistic: 0.06 } },
  { code: '601328', name: '交通银行',   dividendPerShare: 0.3247, asOfYear: '2025', referencePrice: 6.67,  priceAsOf: '2026-05-11', category: '银行',
    growth: { pessimistic: 0.00, neutral: 0.03, optimistic: 0.05 } },
  { code: '600036', name: '招商银行',   dividendPerShare: 2.016,  asOfYear: '2025', referencePrice: 37.97, priceAsOf: '2026-05-11', category: '银行',
    growth: { pessimistic: 0.03, neutral: 0.08, optimistic: 0.13 } },
  { code: '601166', name: '兴业银行',   dividendPerShare: 1.066,  asOfYear: '2025', referencePrice: 17.73, priceAsOf: '2026-05-11', category: '银行',
    growth: { pessimistic: 0.02, neutral: 0.06, optimistic: 0.10 } },
  { code: '601838', name: '成都银行',   dividendPerShare: 0.921,  asOfYear: '2025*', referencePrice: 19.04, priceAsOf: '2026-05-11', category: '银行',
    disclosureNote: '2025 年度分红方案已董事会通过，拟每 10 股派 9.21 元，尚待股东会审议',
    growth: { pessimistic: 0.00, neutral: 0.04, optimistic: 0.07 } },
  { code: '002142', name: '宁波银行',   dividendPerShare: 1.200,  asOfYear: '2025*', referencePrice: 32.68, priceAsOf: '2026-05-11', category: '银行',
    disclosureNote: '2025 年全年 = 2025 中期 0.30 + 2025 末期 0.90；末期方案已董事会通过，尚待股东会审议',
    growth: { pessimistic: 0.02, neutral: 0.06, optimistic: 0.09 } },
  { code: '600919', name: '江苏银行',   dividendPerShare: 0.5641, asOfYear: '2025*', referencePrice: 11.36, priceAsOf: '2026-05-11', category: '银行',
    disclosureNote: '2025 年全年 = 2025 中期 0.3309 + 2025 末期 0.2332；末期方案已董事会通过，尚待股东会审议',
    growth: { pessimistic: 0.02, neutral: 0.05, optimistic: 0.08 } },

  // 能源 / 公用
  { code: '600900', name: '长江电力',   dividendPerShare: 0.943,  asOfYear: '2025*', referencePrice: 27.01, priceAsOf: '2026-05-11', category: '能源',
  ...
  { code: '601006', name: '大秦铁路',   dividendPerShare: 0.269,  asOfYear: '2024', referencePrice: 5.38,  priceAsOf: '2026-05-11', category: '基建',
  ...
  { code: '601088', name: '中国神华',   dividendPerShare: 2.010,  asOfYear: '2025', referencePrice: 45.17, priceAsOf: '2026-05-11', category: '能源',
    growth: { pessimistic: -0.05, neutral: 0.03, optimistic: 0.10 } },
  { code: '600028', name: '中国石化',   dividendPerShare: 0.200,  asOfYear: '2025', referencePrice: 5.21,  priceAsOf: '2026-05-11', category: '能源',
    growth: { pessimistic: -0.03, neutral: 0.02, optimistic: 0.05 } },
  { code: '601857', name: '中国石油',   dividendPerShare: 0.470,  asOfYear: '2025', referencePrice: 11.11, priceAsOf: '2026-05-11', category: '能源',
    growth: { pessimistic: -0.02, neutral: 0.03, optimistic: 0.08 } },
  { code: '601919', name: '中远海控',   dividendPerShare: 1.000,  asOfYear: '2025*', referencePrice: 14.05, priceAsOf: '2026-05-11', category: '基建',
    disclosureNote: '2025 年全年 = 2025 中期 0.56 + 2025 末期 0.44；末期方案已董事会通过，尚待股东会审议',
    growth: { pessimistic: -0.20, neutral: 0.00, optimistic: 0.15 } },
  { code: '600188', name: '兖矿能源',   dividendPerShare: 0.500,  asOfYear: '2025', referencePrice: 21.41, priceAsOf: '2026-05-11', category: '能源',
    growth: { pessimistic: -0.15, neutral: 0.00, optimistic: 0.10 } },
  { code: '600377', name: '宁沪高速',   dividendPerShare: 0.490,  asOfYear: '2025', referencePrice: 12.23, priceAsOf: '2026-05-11', category: '基建',
    growth: { pessimistic: 0.00, neutral: 0.03, optimistic: 0.05 } },

  // 消费
  { code: '000651', name: '格力电器',   dividendPerShare: 3.000,  asOfYear: '2024', referencePrice: 40.46, priceAsOf: '2026-05-11', category: '消费',
    disclosureNote: '2025 年度末期方案尚未披露，暂用 2024 年全年合计（中期 1.00 + 末期 2.00）',
    growth: { pessimistic: 0.00, neutral: 0.05, optimistic: 0.10 } },
  { code: '000333', name: '美的集团',   dividendPerShare: 4.300,  asOfYear: '2025', referencePrice: 80.67, priceAsOf: '2026-05-11', category: '消费',
    growth: { pessimistic: 0.03, neutral: 0.08, optimistic: 0.12 } },
  { code: '600887', name: '伊利股份',   dividendPerShare: 1.220,  asOfYear: '2025*', referencePrice: 28.06, priceAsOf: '2026-05-11', category: '消费',
    disclosureNote: '2025年全年 = 中期0.48（2025-12已派）+ 末期约0.74（按2025-2027承诺1.22元/年底线推算），末期方案待披露',
    growth: { pessimistic: 0.02, neutral: 0.06, optimistic: 0.10 } },
  { code: '000858', name: '五粮液',     dividendPerShare: 5.156,  asOfYear: '2025*', referencePrice: 91.81, priceAsOf: '2026-05-11', category: '消费',
  ...
  // 通信
  { code: '600941', name: '中国移动',   dividendPerShare: 4.790,  asOfYear: '2025*', referencePrice: 97.68, priceAsOf: '2026-05-11', category: '通信',
    disclosureNote: '2025 末期 A 股人民币派发金额待后续公告，当前值按 HKD→CNY≈0.91 临时折算',
    growth: { pessimistic: 0.02, neutral: 0.05, optimistic: 0.08 } },
  { code: '601728', name: '中国电信',   dividendPerShare: 0.272,  asOfYear: '2025*', referencePrice: 6.14,  priceAsOf: '2026-05-11', category: '通信',
...
const DIVIDEND_ETFS: DividendAssetRef[] = [
  ...
  { code: '159589', name: '红利ETF广发', assetType: 'etf', category: '红利ETF',
    dividendPerShare: 0.0253, asOfYear: '2025', referencePrice: 1.089, priceAsOf: '2026-05-20',
    sourceProvider: '天天基金网', sourceAsOf: '2026-05-20',
    sourceNote: '跟踪中证红利指数（广发，成立于2024-03）；月度分派，2025年12次合计0.0253元',
    growth: { pessimistic: 0.00, neutral: 0.03, optimistic: 0.06 } },
  // 红利低波ETF
